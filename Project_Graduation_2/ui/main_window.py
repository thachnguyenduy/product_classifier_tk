...
class MainWindow:
    ...
    def process_bottle(self):
        ...
        try:
            ...
            # CHỤP NHIỀU ẢNH
            num_frames = getattr(__import__("config"), "NUM_CAPTURE_FRAMES", 5)
            frame_delay = getattr(__import__("config"), "FRAME_DELAY", 0.1)
            frames = []
            ...
            for i in range(num_frames):
                ...
                time.sleep(frame_delay)  # Delay giữa các ảnh
